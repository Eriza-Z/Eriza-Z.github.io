  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <Image src="https://cdn.discordapp.com/attachments/971801947910848582/1019433060028129390/IMG_20220903_183158.jpg" alt="Eriza Zehezkiel Gracia" className="img-fluid lazy" id="HeroImage" width={756.792452829} height={350} layout="relative" />
