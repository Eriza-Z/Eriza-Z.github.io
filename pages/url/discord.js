    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1960 320"><path fill="#000000" fill-opacity="1" d="M0,288L1440,288L1440,320L0,320Z"></path></svg>
          <h1 className="bottom-5 tengah"><a href='https://discord.gg/gWQzz52djZ' rel='noreferrer noopenner'>Click Here</a></h1>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1960 320"><path fill="#000000" fill-opacity="1" d="M0,288L1440,288L1440,320L0,320Z"></path></svg>
        </section>
      </main>
      <footer className={"tengah bottom-4 top-5"}>
        <p className="putih">
