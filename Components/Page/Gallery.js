        ...
        >
          <figure className={style.gallery__thumb}>
            <Image
              ...
              className={style.gallery__image}
            />
            <figcaption className={style.gallery__caption}>Sawah</figcaption>
          </figure>
        </a>
        ...
        >
          <figure className={style.gallery__thumb}>
            <Image
              ...
              className={style.gallery__image}
            />
            <figcaption className={style.gallery__caption}>Toba</figcaption>
          </figure>
        </a>
        ...
        >
          <figure className={style.gallery__thumb}>
            <Image
              ...
              className={style.gallery__image}
            />
            <figcaption className={style.gallery__caption}>SPBU</figcaption>
          </figure>
        </a>
      </div>
    </section>
