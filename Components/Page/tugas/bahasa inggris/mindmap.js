function Bingmap() {
  return (
    <section className="justify-between md-12 p-12 top-8 text-white">
      <div className="text-center" id="Pengenalan">
        ...
        <h3 className="pt-8 animate__animated animate__fadeIn">
          Topic: <strong>Conditional Sentence</strong>
        </h3>
      </div>
      <div className="text-start mb-4 mt-8" data-aos="fade-right" id="definisi">
        <h2>Definiton of Conditional Sentence</h2>
        <p>
          Conditional sentence is a type of sentence that expresses a condition
          and the outcome of that condition occurring. Conditional sentences are
          made up of a dependent clause and an independent clause joined by a
      ...
      >
        ...
        <h4 className="pt-2">
          ...
          <p className="text-clip ml-8 my-2">
            This conditional type used to express general truths or facts that
            are always true, regardless of the specific context. They are
            typically used to describe scientific laws, natural phenomena, or
            other universal principles.
          </p>
          2. Type-1/First Conditional
          <p className="text-clip ml-8 my-2">
            This conditional type used to express a real or likely condition in
            the present or future and its probable result. They are typically
            used to make predictions, give advice, or state the consequences of
            an action
          </p>
          3. Type-2/Second Conditional
          <p className="text-clip ml-8 my-2">
            This conditional type used to express a hypothetical or unlikely
            condition in the present or future and its probable result. They are
            typically used to express wishes, regrets, or speculation.
          </p>
